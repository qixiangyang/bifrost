...
export const ModelPlaceholders = {
	...
	minimax: "e.g. MiniMax-M3, MiniMax-M2.7, speech-2.8-turbo",
...
export const PROVIDER_SUPPORTED_REQUESTS: Record<BaseProvider, string[]> = {
	...
	minimax: ["list_models", "chat_completion", "chat_completion_stream", "responses", "responses_stream", "speech", "speech_stream"],
	replicate: [
		"list_models",
		"text_completion",
		"chat_completion",
