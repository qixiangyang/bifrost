...
You will see log lines like `Complexity: tier=REASONING score=0.38 words=25`. This lets you audit how traffic is being distributed and spot mis-classifications to tune thresholds or keyword lists.
